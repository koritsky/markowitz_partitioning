...
import dimod
import hybrid
from modules.simcim_sampler import SimCIMSampler
...
def Kerberos(max_iter=100, max_time=None, convergence=3, energy_threshold=None,
    ...
    Decomposed solver:
        simcim (bool):
            If True => uses simcim solver. Else: standard dwave.
    ...
    if not simcim:
        subproblem_solver = hybrid.QPUSubproblemAutoEmbeddingSampler(num_reads=qpu_reads,
